...
<!-- #region activity=true hideCode=true hidePrompt=true heading_collapsed=true -->
#### Example solution

*Click the arrow in the sidebar or run this cell to reveal an example solution.*
<!-- #endregion -->

<!-- #region activity=true hideCode=true hidePrompt=true hidden=true -->
...
<!-- #region activity=true hideCode=true hidePrompt=true tags=["alert-danger"] -->
