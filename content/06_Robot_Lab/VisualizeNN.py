# # VisualizeNN.py
#
# Original code: https://raw.githubusercontent.com/jzliu-100/visualize-neural-network/master/VisualizeNN.py
#
# Contributor: Jianzheng Liu, jzliu.100@gmail.com
#
# Based the work by Milo Spencer-Harper and Oli Blum, https://stackoverflow.com/a/37366154/10404826, with added support for showing weights (linewidth, colors, etc.)
#
# Open issue on possible display parameter updates: https://github.com/jzliu-100/visualize-neural-network/issues/3
...
def mlp_structure(inputs, hidden, outputs):
    return np.hstack(([inputs], np.asarray(hidden), [outputs]))
