...
Although the current simulator view, any other displayed widgets, and the internal state of the simulator and the notebook’s own Python environment, are *not* saved, re-running the code cells that create them will generate them afresh.
