...
In the next notebook in the series, you will see how we can use this automation approach to collect image and class data "in bulk" from the simulator.
