...
Modify the *x* or *y*-co-ordinates used to locate the robot by by a few pixel values away from the sampling point origins and test the ability of the network to recognise digits that are lightly off-centre in the image array.
